...
4. **What you will do**, in the same warm register: a short section that
   tells a stranger what the five sessions actually are. Anna has not yet
   written the five lines, so build the section from what SITAM itself says
   the first book teaches — you take your own measurements, draw your block
   with the SITAM rule, turn it into the design you want, cut it, sew it, and
   wear it — and leave a clearly marked place for her five session-by-session
   lines when they arrive. Nothing invented about what happens in session
   three.
