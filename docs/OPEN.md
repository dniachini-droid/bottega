...
session loads is about 2,668 tokens, and what the **heaviest single** session
loads — a builder, once it opens the build skill — is about 7,216. Both
against the same limit of 10,000.
